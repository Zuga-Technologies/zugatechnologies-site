...
> **SUPERSEDED by [ADR-0004](./0004-master-accent-lime.md) (2026-06-30).** The master
> Zuga accent is no longer cyan — the brand unified to acid lime `#a3e635` to match the
> zugabot.ai product identity. This ADR is retained as historical record of the cyan-500
> vs cyan-700 stop decision; its reasoning no longer governs the live master accent.
